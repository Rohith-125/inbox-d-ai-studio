...
const LoginPage = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (email === "live.admin@inboxd.com" && password === "password") {
      localStorage.setItem("auth_token", "mock_token_12345");
      toast.success("Welcome back to Inbox'd!");
      navigate("/dashboard");
    } else {
      toast.error("Invalid credentials. Try: live.admin@inboxd.com / password");
    }
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
            ...
            <form onSubmit={handleLogin} className="space-y-5">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    type="email"
                    placeholder="live.admin@inboxd.com"
                    value={email}
          ...
          <p className="mt-6 text-center text-xs text-muted-foreground">
            Demo credentials: live.admin@inboxd.com / password
          </p>
        </div>
      </div>
    </div>
